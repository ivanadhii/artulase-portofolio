                  ...
                  <dl className="space-y-2">
                    {contact.workingHours.map((schedule, index) => (
                      <div key={index} className="flex justify-between">
                        <dt className="font-medium text-gray-900">{schedule.day}</dt>
                        <dd className="text-gray-600">{schedule.hours}</dd>
                      </div>
                    ))}
                  </dl>
                </div>
                ...
                <div className="flex gap-4">
                  {contact.social.instagram && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 bg-gradient-to-br from-purple-600 to-pink-500 rounded-lg flex items-center justify-center text-white hover:opacity-90 transition-opacity"
                    >
